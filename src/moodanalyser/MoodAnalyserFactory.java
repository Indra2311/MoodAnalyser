...
public class MoodAnalyserFactory {
	...
	public static String invokedMethod(MoodAnalyser moodAnalyser, String methodName) throws MoodAnalyserException {
		try {
			...
			throw new MoodAnalyserException("Method Not Found",
					MoodAnalyserException.UserDefineDataType.NO_SUCH_METHOD);
		}
		return null;
	}

	public static Object setFieldValue(Object moodAnalyser, String message, String fieldName)
		...
		try {
			...
			throw new MoodAnalyserException(e.getMessage(),
					MoodAnalyserException.UserDefineDataType.FIELD_INVOCATION_ISSUE);
		}
		return null;
	}
}
